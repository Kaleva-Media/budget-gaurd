...
- **Monthly plan:** a searchable two-sided income/expense ledger with account assignment, expense ordering by name or amount, quick paid/undo actions, separate paid expenses, and flexible category envelopes.
...
The Android app is BudgetGuard's primary daily experience. It includes email authentication and a three-step onboarding flow for profile and account setup, a present-tense dashboard, transaction review and category assignment, editable account purposes and SMS mappings, and system-inset-safe navigation. Users can create and rename entities such as Personal, Kaleva Media, and MTG, switch the entire dashboard between them, and assign or move accounts from the account editor. Each entity has independent periods, carry-over, plans, balances, budgets, debts, and activity. A period selector presents planning boundaries as ranges such as “September – October 2026”; creating the next period carries forward that entity's previous projected surplus and copies its recurring plan items and category limits for a useful forecast. Flexible category limits can be added, edited, changed, or removed directly on Android for the selected entity and period; the dashboard shows remaining money, daily pace, pending spend, and over-limit categories. Expected income and expenses can be added, edited, assigned to accounts, repeated monthly, moved between existing periods or entities, or removed directly from the period-plan card. The plan is searchable across income and expenses; expenses can be ordered by name or amount, marked paid in one tap, undone when manually confirmed, and reviewed in separate To pay and Paid groups. Cross-entity moves clear the old account and any personal/business category that does not apply at the destination; entries with matched payments stay in their original period. Expenses can also be classified as fixed, variable, savings, or debt payments and assigned to an entity-appropriate category: Personal uses the household taxonomy while company and other entities use business expense categories.

The separate **Debt freedom** section onboards balances, APRs, minimum payments, optional terms and due days, secured status, and arrears. It estimates monthly debt capacity from the active entity's planned recurring income, living expenses, and flexible category limits; projected carry-over is deliberately not repeated as monthly income. The recommendation engine chooses avalanche, snowball, a quick-win/avalanche hybrid, review of a user-entered consolidation offer, or registered debt counselling/debt-management support. Consolidation is recommended only when an entered offer is affordable and estimates at least 5% savings. Arrears, unaffordable minimums, or a plan that cannot amortize within 50 years route to professional support. Results are educational estimates and never tell users to stop required payments.

The plan turns that recommendation into a monthly next action, a solid actual/dashed forecast balance chart, per-debt payoff events, 25/50/75/100% milestones, and comparable time/interest estimates for the three direct-payoff approaches. Monthly check-ins atomically capture every active debt and recalculate the route; a zero balance preserves the debt as paid off instead of deleting its history. Optional generic reminders open Debt freedom, while the in-app due card works without notification permission. Spending scenarios use the median of up to three completed months only when at least two months and 75% categorisation coverage are available. Users choose the categories and a 5–30% reduction, preview the time and interest effect, and explicitly open the existing budget editor—no limit is changed automatically.

The side navigation provides entity switching, Home, Debt freedom, Activity, Invoice inbox, Accounts, Profile & sync, and sign-out access; the profile surface shows SMS permission, collector health, pending queue count, and manual sync.

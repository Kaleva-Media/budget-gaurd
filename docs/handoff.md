...
Updated: 2026-09-22. Production source baseline: `075eb45` (`main`).
...
Android source build version: `0.5.3`, version code `14`. This does not prove which APK a user currently has installed.

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1dbc6a4f8e8b344cda7101f139bca253)
// Runtime types generated with workerd@1.20260911.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	INVOICE_DOMAIN: "inbox.budget.cloudcomms.co.za";
	INGEST_URL: "https://budget.cloudcomms.co.za/functions/v1/invoice-ingest";
	MAX_PDF_BYTES: "15728640";
	MAX_PDFS_PER_EMAIL: "5";
	INVOICE_INGRESS_PRIVATE_JWK: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INVOICE_DOMAIN" | "INGEST_URL" | "MAX_PDF_BYTES" | "MAX_PDFS_PER_EMAIL" | "INVOICE_INGRESS_PRIVATE_JWK" | "SUPABASE_ANON_KEY">> {}
}
